...
The map of the 81 sky cultures is below. The .json format currently has 37 (this number is growing). The number in parentheses counts constellations with line figures, but the data contains many other unlined star groups, and names for stars and other sky objects.
