...
The map of 75 sky cultures below. The .json format currently has 33 (this number is growing). The number in parentheses counts constellations with line figures. Note: the .json data contains more lined constellations compared to this map: +1 in Kolam and +1 in Pardhi, and +4 cultures (Iroquois with 3, Bororo with 16, Mocovi with 8, and Toba with 3 lined constellations, but many other star groups and names for stars and other sky objects).
